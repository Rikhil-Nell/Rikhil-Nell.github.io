...
None of that came from a course. Most of it came from 14-hour days, reading source code, and breaking things until they worked.
...
1. **Accountability.** If I say I'm building something publicly, I actually have to build it.
2. **Thinking clearly.** Writing forces you to understand what you're doing, not just hack until it works.
3. **Finding people.** The best collaborators and opportunities come from putting your work out there, not from attending conferences and hoping someone notices you.

## What to Expect

Technical deep-dives on:
- Voice agent architectures (LiveKit, SIP, Asterisk, the whole stack)
- Building multi-agent systems that actually work in production
- Infrastructure decisions for AI-heavy backends
- Lessons from shipping at startups as a college student from a Tier 2 city in India

No fluff, no "10x developer" nonsense. Just what I'm building and what I'm learning.
